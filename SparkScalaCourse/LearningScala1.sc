object LearningScala1 {
  ...
  val isGreater = 2 > 1                           //> isGreater  : Boolean = true
  val isLesser = 2 < 1                            //> isLesser  : Boolean = false
  ...
  val piValue = 3.14                              //> piValue  : Double = 3.14
  val piValue_2 = piValue * 2                     //> piValue_2  : Double = 6.28
  val result = piValue_2.toString                 //> result  : String = 6.28
  println(result)                                 //> 6.28
