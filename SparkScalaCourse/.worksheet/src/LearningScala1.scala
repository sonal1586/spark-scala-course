object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(127); 
  ...
  val isGreater = 2 > 1;System.out.println("""isGreater  : Boolean = """ + $show(isGreater ));$skip(23); 
  val isLesser = 2 < 1;System.out.println("""isLesser  : Boolean = """ + $show(isLesser ));$skip(40); 
  ...
  val piValue = 3.14;System.out.println("""piValue  : Double = """ + $show(piValue ));$skip(30); 
  val piValue_2 = piValue * 2;System.out.println("""piValue_2  : Double = """ + $show(piValue_2 ));$skip(34); 
  val result = piValue_2.toString;System.out.println("""result  : String = """ + $show(result ));$skip(18); 
  println(result)}
